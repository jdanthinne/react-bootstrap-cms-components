...
var TextArea = function (_a) {
    ...
    return (React.createElement("div", { className: "form-group " + (!context.vertical ? "row" : "") },
        ...
        React.createElement(FieldWrapper, { vertical: context.vertical },
            React.createElement("textarea", { className: "form-control " + (error ? "is-invalid" : ""), name: name, id: name, rows: 4, onBlur: (_d = context.form) === null || _d === void 0 ? void 0 : _d.handleBlur, onChange: (_e = context.form) === null || _e === void 0 ? void 0 : _e.handleChange, required: required, autoCapitalize: autoCapitalize, autoCorrect: autoCorrect, disabled: disabled ||
                    (context.editMode && context.loading) || ((_f = context.form) === null || _f === void 0 ? void 0 : _f.isSubmitting), value: (_g = context.form) === null || _g === void 0 ? void 0 : _g.values[name] }),
