...
var DateField = function (_a) {
    ...
    return (React.createElement("div", { className: "form-group " + (!context.vertical ? "row" : "") },
        ...
        React.createElement(FieldWrapper, { vertical: context.vertical },
            React.createElement(DatePicker, { locale: "fr", clearButtonTitle: intl.formatMessage({ id: "actions.clear" }), todayButton: intl.formatMessage({ id: "misc.today" }), showTimeSelect: showTime, dateFormat: showTime ? "dd/MM/yyyy - HH:mm" : "dd/MM/yyyy", isClearable: !required, placeholderText: "jj/mm/aaaa", className: "form-control " + (error ? "is-invalid" : ""), name: name, id: name, selected: (_d = context.form) === null || _d === void 0 ? void 0 : _d.values[name], onChange: function (date) { var _a; return (_a = context.form) === null || _a === void 0 ? void 0 : _a.setFieldValue(name, date); }, onBlur: (_e = context.form) === null || _e === void 0 ? void 0 : _e.handleBlur, required: required, disabled: disabled ||
                    (context.editMode && context.loading) || ((_f = context.form) === null || _f === void 0 ? void 0 : _f.isSubmitting) }),
